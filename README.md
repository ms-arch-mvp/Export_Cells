...
* Overwrite MWSE.dll in the game directory if you want to use character export functions. MWSE.dll has been provided by [Greatness7](https://github.com/Greatness7) ands adds the method shape:applySkinDeform()
* Install [io_scene_mw_mvp](https://github.com/ms-arch-mvp/io_scene_mw_mvp) if you want to import into Blender, with ignore_armatures and ignore_animations enabled to prevent issues.
